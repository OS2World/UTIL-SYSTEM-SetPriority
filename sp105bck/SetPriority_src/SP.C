...
/* letzte énderung: Jens Glathe 22.02.1996                                 */
...
int main(int argc, char *argv[])
{
  if (argc < 3)
  {
		printf("\nSetPriority Version 1.04 (c) 1993..1996 Jens Glathe, Scott Dudley\n\n");
		...
		printf("[delta]:  Any number from 0 to 31, also for DOS sessions\n");
		printf("<sessiontype>:  o=OS/2 Window or PM App, d=DOS-Window\n");
	...
	*args='\0';
	...
	printf("SP: running %s, %s priority, delta %ld\n",
